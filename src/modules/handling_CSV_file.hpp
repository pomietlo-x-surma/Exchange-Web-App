...
void write_logs_user_auth(const std::string& email, const std::string& login, const std::string& password, const std::string& file_path = path_to_user_auth_csv);
void write_logs_currencies(const std::string& login, const std::string& dollar, const std::string& euro, const std::string& zloty, bool reg = false);
